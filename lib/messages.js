...
*                                                                                *
*  We have 3 different setps to setup the project. You don't need to finish      *
*  all 3, but you'd need to stay in order. So, please complete e.g. 1 before 2.  *
...
The first value is the URL to the repository, where the app can find filed issues. 
...
step3 : `
 We just added the paths to your backup as well as image upload automatically. 
 You are done! \n`
}